...
export const OPERATORS = [
  ...
  // Afrique du Sud (ZAR)
  { id: 'fincra-zar-bt',   name: 'Virement bancaire', flag: '🇿🇦', country: 'ZA', withdraw: true, fincra: true, currency: 'ZAR', rail: 'bank_transfer', logo: require('../../assets/operators/pay_bank.png') },
