...
const PAYMENT_MODE_LOGOS: Record<string, ImageSourcePropType> = {
  ...
  'djamo-ci': require('../../assets/operators/pay_djamo.png'),
  'djamo-sn': require('../../assets/operators/pay_djamo.png'),
...
const MODE_LABELS: Record<string, string> = {
  ...
  'orange-money-ci': 'Orange Money', 'wave-ci': 'Wave', 'djamo-ci': 'Djamo', 'djamo-sn': 'Djamo',
